...
var map = L.map("map").setView([50.64085047027005, 3.06398356256799], 13);
...
var marker = L.marker([50.64085047027005, 3.06398356256799]).addTo(map);
marker
  .bindPopup(
    "<div style='text-align:center;'><b>Retrouvez nous !</b><br>6 Rue de la Monnaie<br>59800 Lille</div>",
  )
  .openPopup();
